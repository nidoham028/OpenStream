...
public final class FragmentFavoriteBinding implements ViewBinding {
  ...
  @NonNull
  public final FrameLayout favoriteFragment;

  @NonNull
  public final TextView tvEmpty;

  private FragmentFavoriteBinding(@NonNull FrameLayout rootView,
      @NonNull FrameLayout favoriteFragment, @NonNull TextView tvEmpty) {
  ...
  public static FragmentFavoriteBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      FrameLayout favoriteFragment = (FrameLayout) rootView;
      ...
      return new FragmentFavoriteBinding((FrameLayout) rootView, favoriteFragment, tvEmpty);
    }
